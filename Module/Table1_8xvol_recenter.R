...
Table1_8x_recenter <- restructure_table1(Table1_results,h_list)

### Save and view
save(Table1_8x_recenter, file = "Module/Table1_8xvol_recenter_ratio5_lag10.Rdata")

View(Table1_8x_recenter)
